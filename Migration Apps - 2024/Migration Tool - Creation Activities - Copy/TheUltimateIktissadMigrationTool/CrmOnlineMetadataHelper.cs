...
namespace TheUltimateIktissadMigrationTool
{
    public class CrmOnlineMetadataHelper
    {
        ...
        public Dictionary<int?, string> ObjectTypeCodeToEntityName;
        ...
        public CrmOnlineMetadataHelper(IOrganizationService crmService)
        {
            ...
            ObjectTypeCodeToEntityName = new Dictionary<int?, string>();
           ...
           // RetrieveAllEntitiesRequest request = new RetrieveAllEntitiesRequest()
            ...
            ////{
            ////    ObjectTypeCodeToEntityName[entity.ObjectTypeCode] = entity.SchemaName;
            ////}
            ...
            foreach (AttributeMetadata currentAttribute in currentEntity.Attributes)
            {
                ...
                if (currentAttribute.AttributeOf == null)
                {
                    ...
                    else if (currentAttribute.GetType() == typeof(LookupAttributeMetadata))
                    {
                        ...
                        {
                            if (lookupMetadata.Targets.Length == 2 && (lookupMetadata.Targets[0] == "systemuser" || lookupMetadata.Targets[0] == "team"))
                            {
                                LookupTargets.Add(AttributeName, "systemuser");
                            }
                            else if (lookupMetadata.Targets.Length == 2 && (lookupMetadata.Targets[0] == "contact" || lookupMetadata.Targets[0] == "account"))
                            {
                                LookupTargets.Add(AttributeName, "customer");
                            }
                            else
                            {
                                LookupTargets.Add(AttributeName, "regarding");
                            }
                        }
                        else if (lookupMetadata.Targets.Length == 1)
                        {
        ...
        private Dictionary<Guid, Guid> GetUomMap()
        {
            ...
            // // //d81424ba-f7b9-eb11-8236-000d3ab4912e
            // UomMap.Add(new Guid("B9FFEDF6-BC3B-DE11-844A-001E0BD83A70"), new Guid("8ea8e47a-beef-eb11-bacb-000d3ade7215"));//1 job
            // //1
            // UomMap.Add(new Guid("D64B7C1E-6E5F-E011-8618-001E0BD83A70"), new Guid("93a8e47a-beef-eb11-bacb-000d3ade7215"));//1 1
            // //bolts
            // UomMap.Add(new Guid("2B6DDBEF-EA08-E011-BCF8-001E0BD83A70"), new Guid("2b6ddbef-ea08-e011-bcf8-001e0bd83a70"));//package
            // UomMap.Add(new Guid("CECC6BC1-EA08-E011-BCF8-001E0BD83A70"), new Guid("9fa8e47a-beef-eb11-bacb-000d3ade7215"));//bolt
            // //CD
            // UomMap.Add(new Guid("D9B56519-7D04-DD11-919C-000476F463C4"), new Guid("81a8e47a-beef-eb11-bacb-000d3ade7215"));//CD1
            // //CPU
            // UomMap.Add(new Guid("F22C61AF-E212-E711-80C3-00155D000F1F"), new Guid("89a8e47a-beef-eb11-bacb-000d3ade7215"));//CPU 1
            // //Day
            // UomMap.Add(new Guid("26807C1C-D300-DD11-AA9E-000476F463C4"), new Guid("84a8e47a-beef-eb11-bacb-000d3ade7215"));// 1
            // //Default Unit
            // UomMap.Add(new Guid("5232912F-AE67-4B92-99F0-02C0370EB400"), new Guid("f093a962-7c2d-40a4-81f5-9bf7a0b319de"));//Primary Unit
            // //Framework
            // UomMap.Add(new Guid("3556FF00-BD3B-DE11-844A-001E0BD83A70"), new Guid("8fa8e47a-beef-eb11-bacb-000d3ade7215"));//Framework1
            // //Hour
            // //3556ff00-bd3b-de11-844a-001e0bd83a70
            ...
            // UomMap.Add(new Guid("5C425F0A-D300-DD11-AA9E-000476F463C4"), new Guid("82a8e47a-beef-eb11-bacb-000d3ade7215"));//120
            ...
            // UomMap.Add(new Guid("7643B48D-9A3B-DE11-844A-001E0BD83A70"), new Guid("8ca8e47a-beef-eb11-bacb-000d3ade7215"));//1 Incidents
            ////License
            // UomMap.Add(new Guid("1AB6AC7E-9BA9-DD11-9F6E-001E0BD83A6E"), new Guid("8aa8e47a-beef-eb11-bacb-000d3ade7215"));//1 License
            // //Maintenance
            // UomMap.Add(new Guid("D8649AF0-FC97-E011-A005-001E0BD83A70"), new Guid("97a8e47a-beef-eb11-bacb-000d3ade7215"));//1
            // //Manday
            // UomMap.Add(new Guid("107FCD03-403B-DE11-844A-001E0BD83A70"), new Guid("8ba8e47a-beef-eb11-bacb-000d3ade7215"));//1 Manday
            // //Month
            // UomMap.Add(new Guid("74FA7C25-558C-E011-8AE0-001E0BD83A70"), new Guid("94a8e47a-beef-eb11-bacb-000d3ade7215"));//1 Month
            // //Pack of hours
            // UomMap.Add(new Guid("BB27AA12-BD3B-DE11-844A-001E0BD83A70"), new Guid("91a8e47a-beef-eb11-bacb-000d3ade7215"));//1 Pack of hours
            // //Package
            // UomMap.Add(new Guid("13C08799-DCD8-E211-AB79-001E0BD83A70"), new Guid("9da8e47a-beef-eb11-bacb-000d3ade7215"));//1 Package
            // //Person update 
            // UomMap.Add(new Guid("FA854A46-9B3B-DE11-844A-001E0BD83A70"), new Guid("8da8e47a-beef-eb11-bacb-000d3ade7215"));//
            // //Piece

            // UomMap.Add(new Guid("C2343630-D300-DD11-AA9E-000476F463C4"), new Guid("88a8e47a-beef-eb11-bacb-000d3ade7215"));//
            // // SAL
            // UomMap.Add(new Guid("CBD9C642-CBF1-DD11-A3B8-001E0BD83A70"), new Guid("98a8e47a-beef-eb11-bacb-000d3ade7215"));//1 SAL
            // // Scope update
            // UomMap.Add(new Guid("C1BAE963-CBF1-DD11-A3B8-001E0BD83A70"), new Guid("99a8e47a-beef-eb11-bacb-000d3ade7215"));//1 Scope
            // //Session
            ...
            // UomMap.Add(new Guid("62906D37-591A-E011-9C5B-001E0BD83A70"), new Guid("96a8e47a-beef-eb11-bacb-000d3ade7215"));//Session 4
            // UomMap.Add(new Guid("4DF009A4-591A-E011-9C5B-001E0BD83A70"), new Guid("4df009a4-591a-e011-9c5b-001e0bd83a70"));//Session 2
            // //unit
            // UomMap.Add(new Guid("26F3BA82-CBF1-DD11-A3B8-001E0BD83A70"), new Guid("9aa8e47a-beef-eb11-bacb-000d3ade7215"));//Session 6
            // //user
            ...
            // UomMap.Add(new Guid("40FFBB25-D300-DD11-AA9E-000476F463C4"), new Guid("86a8e47a-beef-eb11-bacb-000d3ade7215"));//1 user
        ...
        {
            var UomMap = new Dictionary<Guid, Guid>();
            UomMap.Add(new Guid("36B5EB2C-117F-491F-9C7D-E7003544057D"), new Guid("4508341c-9838-4cf9-9683-af3bc2827836"));//default unit
        ...
        private Dictionary<Guid, Guid> GetteamMap()
        {
            ...
            //TeamMap.Add(new Guid("4F43E441-CB83-E611-80C0-00155D000F1F"), new Guid("44ba80d6-79d5-eb11-bacc-000d3ada12e1"));//Daad's Team
            //TeamMap.Add(new Guid("CF12D817-8CE8-E611-80C2-00155D000F1F"), new Guid("0c4d34d6-79d5-eb11-bacc-000d3ada1329"));//Lina's Team
            //TeamMap.Add(new Guid("E72D5DB1-661A-E911-80DE-00155D000F1F"), new Guid("e72d5db1-661a-e911-80de-00155d000f1f"));//Presales Team
            //TeamMap.Add(new Guid("DEC3257D-F81E-E911-80DE-00155D000F1F"), new Guid("dec3257d-f81e-e911-80de-00155d000f1f"));//BS team
            //TeamMap.Add(new Guid("587BE8EB-D041-EA11-80EF-00155D000F1F"), new Guid("084518d0-79d5-eb11-bacc-000d3ada1329"));//Ange's Team
            //TeamMap.Add(new Guid("49588D31-1ECB-EA11-80FB-00155D000F1F"), new Guid("49588d31-1ecb-ea11-80fb-00155d000f1f"));//Sales & Payments (LA)
            //TeamMap.Add(new Guid("6EE94D98-DFCB-EA11-80FB-00155D000F1F"), new Guid("6ee94d98-dfcb-ea11-80fb-00155d000f1f"));//Sales & Payments (BPS)
            ...
            //TeamMap.Add(new Guid("7E248C55-EA11-E511-9864-00155D001305"), new Guid("4dba80d6-79d5-eb11-bacc-000d3ada12e1"));//Support Team
            //TeamMap.Add(new Guid("C29F54CC-0727-E511-9864-00155D001305"), new Guid("034d34d6-79d5-eb11-bacc-000d3ada1329"));//Enterprise Sales
            //TeamMap.Add(new Guid("DB468757-D652-E411-A402-00155D001305"), new Guid("4aba80d6-79d5-eb11-bacc-000d3ada12e1"));//bps me
            //TeamMap.Add(new Guid("CFF03FD7-EF05-E611-B4BE-00155D001305"), new Guid("420035d0-79d5-eb11-bacc-000d3ada12e1"));//Presales
            //TeamMap.Add(new Guid("CA5D0894-3B76-E511-BDE6-00155D001305"), new Guid("094d34d6-79d5-eb11-bacc-000d3ada1329"));//Diana's BU
            //TeamMap.Add(new Guid("3CBFAEC8-1BB4-E311-8B2F-00155D001306"), new Guid("3cbfaec8-1bb4-e311-8b2f-00155d001306"));//SPLA Team
            //TeamMap.Add(new Guid("6DFA7CA7-F80B-E311-A47C-00155D001306"), new Guid("6dfa7ca7-f80b-e311-a47c-00155d001306"));//bpscrm
            //TeamMap.Add(new Guid("6FFA7CA7-F80B-E311-A47C-00155D001306"), new Guid("3f0035d0-79d5-eb11-bacc-000d3ada12e1"));//Professional Services
            //TeamMap.Add(new Guid("71FA7CA7-F80B-E311-A47C-00155D001306"), new Guid("47ba80d6-79d5-eb11-bacc-000d3ada12e1"));//Sales Dept.
            //TeamMap.Add(new Guid("73FA7CA7-F80B-E311-A47C-00155D001306"), new Guid("064d34d6-79d5-eb11-bacc-000d3ada1329"));//Team A
            //TeamMap.Add(new Guid("75FA7CA7-F80B-E311-A47C-00155D001306"), new Guid("340035d0-79d5-eb11-bacc-000d3ada12e1"));//Team b
            //TeamMap.Add(new Guid("18239C1F-ED31-DF11-9556-001E0BD83A70"), new Guid("18239c1f-ed31-df11-9556-001e0bd83a70"));//salea team
            //TeamMap.Add(new Guid("E26B752D-ED31-DF11-9556-001E0BD83A70"), new Guid("e26b752d-ed31-df11-9556-001e0bd83a70"));//admin team
            //TeamMap.Add(new Guid("08A77641-ED31-DF11-9556-001E0BD83A70"), new Guid("474d45e1-48b6-eb11-8236-0022489aee3a"));//bps
            ...
            TeamMap.Add(new Guid("5660B1B2-268A-DD11-B226-000476F463C4"), new Guid("5660b1b2-268a-dd11-b226-000476f463c4"));//PS Team
            TeamMap.Add(new Guid("E26B752D-ED31-DF11-9556-001E0BD83A70"), new Guid("e26b752d-ed31-df11-9556-001e0bd83a70"));//admin team
            TeamMap.Add(new Guid("587BE8EB-D041-EA11-80EF-00155D000F1F"), new Guid("77d0a773-4d06-ec11-94ef-002248830db2"));//Ange's Team
            TeamMap.Add(new Guid("08A77641-ED31-DF11-9556-001E0BD83A70"), new Guid("08a77641-ed31-df11-9556-001e0bd83a70"));//bps
            TeamMap.Add(new Guid("4B94B5F9-1B0D-EB11-80FF-00155D000F1F"), new Guid("4b94b5f9-1b0d-eb11-80ff-00155d000f1f"));//BPS Azure Team
            TeamMap.Add(new Guid("DB468757-D652-E411-A402-00155D001305"), new Guid("0707ac79-4d06-ec11-94ef-002248830db2"));//bps me
            TeamMap.Add(new Guid("4671BD95-3F91-E611-80C0-00155D000F1F"), new Guid("4671bd95-3f91-e611-80c0-00155d000f1f"));//BPS Support Team
            TeamMap.Add(new Guid("CA5D0894-3B76-E511-BDE6-00155D001305"), new Guid("1f07ac79-4d06-ec11-94ef-002248830db2"));//Diana's BU
            TeamMap.Add(new Guid("6DFA7CA7-F80B-E311-A47C-00155D001306"), new Guid("6dfa7ca7-f80b-e311-a47c-00155d001306"));//bpscrm
            TeamMap.Add(new Guid("DEC3257D-F81E-E911-80DE-00155D000F1F"), new Guid("dec3257d-f81e-e911-80de-00155d000f1f"));//BS team
            TeamMap.Add(new Guid("4F43E441-CB83-E611-80C0-00155D000F1F"), new Guid("cdcfa773-4d06-ec11-94ef-002248830db2"));//Daad's Team
            TeamMap.Add(new Guid("15FADA24-F97E-DF11-A55F-001E0BD83A70"), new Guid("15fada24-f97e-df11-a55f-001e0bd83a70"));//dev team
            TeamMap.Add(new Guid("C29F54CC-0727-E511-9864-00155D001305"), new Guid("fd06ac79-4d06-ec11-94ef-002248830db2"));//Enterprise Sales
            TeamMap.Add(new Guid("A1EDEC2B-8C4B-DF11-9A03-001E0BD83A70"), new Guid("a1edec2b-8c4b-df11-9a03-001e0bd83a70"));//infra team
            TeamMap.Add(new Guid("CF12D817-8CE8-E611-80C2-00155D000F1F"), new Guid("6ed0a773-4d06-ec11-94ef-002248830db2"));//Lina's Team
            TeamMap.Add(new Guid("333AC5E4-796F-E611-80C0-00155D000F1F"), new Guid("333ac5e4-796f-e611-80c0-00155d000f1f"));//Machine Creation/Update Team
            TeamMap.Add(new Guid("9EC059D9-7CF9-EA11-80FC-00155D000F1F"), new Guid("9ec059d9-7cf9-ea11-80fc-00155d000f1f"));//Outsourcee Team
            TeamMap.Add(new Guid("E72D5DB1-661A-E911-80DE-00155D000F1F"), new Guid("e72d5db1-661a-e911-80de-00155d000f1f"));//Presales Team
            TeamMap.Add(new Guid("CFF03FD7-EF05-E611-B4BE-00155D001305"), new Guid("1807ac79-4d06-ec11-94ef-002248830db2"));//Presales
            TeamMap.Add(new Guid("6EE94D98-DFCB-EA11-80FB-00155D000F1F"), new Guid("6ee94d98-dfcb-ea11-80fb-00155d000f1f"));//Sales & Payments (BPS)
            TeamMap.Add(new Guid("49588D31-1ECB-EA11-80FB-00155D000F1F"), new Guid("49588d31-1ecb-ea11-80fb-00155d000f1f"));//Sales & Payments (LA)

            TeamMap.Add(new Guid("6FFA7CA7-F80B-E311-A47C-00155D001306"), new Guid("2e07ac79-4d06-ec11-94ef-002248830db2"));//Professional Services
            TeamMap.Add(new Guid("71FA7CA7-F80B-E311-A47C-00155D001306"), new Guid("2607ac79-4d06-ec11-94ef-002248830db2"));//Sales Dept.
            TeamMap.Add(new Guid("18239C1F-ED31-DF11-9556-001E0BD83A70"), new Guid("18239c1f-ed31-df11-9556-001e0bd83a70"));//sales team
            TeamMap.Add(new Guid("7E248C55-EA11-E511-9864-00155D001305"), new Guid("7fd0a773-4d06-ec11-94ef-002248830db2"));//Support Team
            TeamMap.Add(new Guid("3CBFAEC8-1BB4-E311-8B2F-00155D001306"), new Guid("3cbfaec8-1bb4-e311-8b2f-00155d001306"));//SPLA Team
